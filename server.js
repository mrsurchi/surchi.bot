...
〔 s!antibots on 〕⇰ 『 هیچ بۆت ئەک ناتوانی بێتە ناو سێرڤەر』



〔 s!antibots off 〕⇰ 『بۆت دەتوانی بێنیە ناو سێرڤەر 』



〔 s!anti ban 〕⇰ 『  • سنورێک بۆ باند کردن۳بۆ٤ کەس 』



〔 s!anti kick 〕⇰ 『 •  سنورێک بۆ کیک کردن۳بۆ٤ کەس』



〔 s!anti role 〕⇰ 『   •   سنورێک بۆ سڕینەوەی ۳بۆ٤ رۆڵ』



〔 s!anti role 〕⇰ 『  • سنورێک بۆ دروستکردنی ڕۆڵ ۳بۆ ٤   』



〔 s!anti channel 〕⇰ 『 •سنورێک بۆ سڕینەوەی ۳بۆ٤ ڕووم بۆ ئەوکەسانەی پلەدارن』



〔 s!anti time 〕⇰ 『 • ئه وكه سانه ى كه نه فه ر باند ده كه ن روليان ليده ستيندريته وه』



〔 s!invite 〕⇰ 『 • بۆئینڤایت کردنی بۆت بۆ سیرڤەرەکەت 』
...
fs.writeFile("./antibot.json", JSON.stringify(antibots), err => {
  ...
  if (message.content === "s!invite") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setFooter("𝐁𝐘 SURCHI", message.author.avatarURL);
